...
public final class Config {
    ...
    protected final static String SQL_DELETE_QUESTIONS = "DROP TABLE IF EXISTS " + TBQuestions.TABLE_NAME;
    ...
    //Es String con la estructura para ejecutar el Queri de la creación de la tabla.
    protected final static String SQL_CREATE_USER_TABLE = ("CREATE TABLE " + TBUser.TABLE_NAME + " (" +
            TBUser._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
            TBUser.COLUMN_USER + " TEXT NOT NULL," +
            TBUser.COLUMN_SCORE + " INTEGER NOT NULL)");

    protected final static String SQL_DELETE_USER = "DROP TABLE IF EXISTS " + TBUser.TABLE_NAME;
}
